...
const Register = () => {
    ...
    const IsValaccountate = () => {
        ...
        if (!isproceed) {
            ...
            if (/^[a-zA-Z0-9]+@[a-zA-Z0-9]+\.[A-Za-z]+\.[A-Za-z]+$/.test(gmail)) {
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        ...
                                        <input value={account} onChange={e => accountchange(e.target.value)} className="form-control"></input>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="form-group">
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        <label>Gmail <span className="errmsg">*</span></label>
                                        <input value={gmail} onChange={e => gmailchange(e.target.value)} className="form-control"></input>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="form-group">
